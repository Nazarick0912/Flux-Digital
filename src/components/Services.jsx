const servicesData = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m11.218-4.036a9.027 9.027 0 0 1-1.67 5.38 9.027 9.027 0 0 1-5.38 1.67 9.027 9.027 0 0 1-5.38-1.67 9.027 9.027 0 0 1-1.67-5.38V6.228a48.424 48.424 0 0 0 7.03-.55 48.424 48.424 0 0 0 7.03.55v2.486Z" />
      </svg>
    )
  },
];

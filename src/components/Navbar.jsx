    ...
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
            ...
            <ul className='hidden md:flex gap-7 text-white'>
                ...
                <a href="#team" className='cursor-pointer hover:text-gray-400'>Team</a>
            </ul>
            <button className='hidden md:block bg-white px-6 py-2 rounded-full cursor-pointer'>Sign Up</button>
        ...
        <div className={`md:hidden ${showMobileMenu? 'fixed w-full' : 'h-0 w-0'} right-0 top-0 bottom-0 overflow-hidden bg-white/20 backdrop-blur-md transition-all`}>
